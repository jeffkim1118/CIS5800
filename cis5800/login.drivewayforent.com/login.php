...
<body>
    <div id="box">
        <form method="post">
            <a href="http://drivewayforent.com/" style="width:100px; height:100px"><img src = "images/cover.png" alt = "appLogo" class = "appLogo_name" style="width:300px; height:150px;margin-top:50px;"></a>
            
            <img src = "images/loginPagePic.jpg" alt = "loginpic" class = "login_pic">

            <?php 
                if(isset($_GET["register"])){
                    if($_GET["register"] == "success"){
                        echo '<p class = "signupsuccess" style="border: 1px solid white; border-radius: 10px; margin:auto; width:fit-content; background-color: white;">Registration Successful!</p>';
                    }
                }
                if(isset($_GET["loggedout"])){
                    if($_GET["loggedout"] == "true"){
                        echo '<p style="color:white;">You have logged out!</p>';
                    }
                }
            ?>
